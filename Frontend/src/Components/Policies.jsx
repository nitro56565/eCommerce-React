...
const Policies = () => {
    return (
        <div className='flex flex-col md:flex-row bg-[#FAF4F4] md:gap-7 justify-center items-center md:h-72 p-3'>
            ...
            <div className='w-full md:w-1/4 '>
                <h3 className=' md:text-left text-2xl md:text-3xl font-medium'>90 Days Return</h3>
